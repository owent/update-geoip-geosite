...
sed -i.bak -r 's;server\s*=\s*/([^/]+).*;\1;g' ./src/github.com/v2fly/domain-list-community/data/accelerated-domains-cn ;

rm -f ./src/github.com/v2fly/domain-list-community/data/accelerated-domains-cn.bak ;

sed -i.bak '/accelerated-domains-cn/d' ./src/github.com/v2fly/domain-list-community/data/cn ;

echo "include:accelerated-domains-cn" >> ./src/github.com/v2fly/domain-list-community/data/cn ;

rm -f ./src/github.com/v2fly/domain-list-community/data/cn.bak ;

## add gfw
curl -L "$GFWLIST_ORIGIN_URL" -o ./src/github.com/v2fly/domain-list-community/data/gfwlist.txt ;

python patch-gfwlist.py ./src/github.com/v2fly/domain-list-community/data/gfwlist.txt dnsmasq-blacklist.conf "1.1.1.1#53";

rm -f ./src/github.com/v2fly/domain-list-community/data/gfwlist.txt ;

cat ./src/github.com/v2fly/domain-list-community/data/gfw ;
